...
<body class="min-h-screen bg-[#FDF8F2] flex">
  ...
  <div class="hidden lg:flex w-5/12 bg-[#1C1917] flex-col justify-between p-14 relative overflow-hidden">
    <div class="absolute top-0 right-0 w-80 h-80 bg-amber-700 opacity-10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
    ...
    <div class="relative z-10">
      ...
      <ul class="mt-10 space-y-4 text-gray-400 text-sm">
        <li class="flex gap-3 items-start">
          <span class="mt-0.5 w-5 h-5 rounded-full bg-amber-500 text-white text-xs flex items-center justify-center flex-shrink-0">✓</span>
    ...
    <div class="relative z-10">
      <p class="text-gray-600 text-xs">"CoLoc a complètement changé notre quotidien en colocation. Plus de disputes financières !"</p>
      <div class="flex items-center gap-3 mt-4">
        <div class="w-8 h-8 rounded-full bg-amber-500 flex items-center justify-center text-white text-xs font-700">SA</div>
        <div>
  ...
  <div class="flex-1 flex items-center justify-center px-6 lg:px-16 py-12">
    <div class="w-full max-w-lg">
      ...
      <form action="/register" method="POST" class="space-y-4 fade-up-2">

        <div class="grid grid-cols-2 gap-4">
          <div>
            <label class="block text-sm font-600 text-[#1C1917] mb-1.5">Prénom</label>
          ...
          <div>
            <label class="block text-sm font-600 text-[#1C1917] mb-1.5">Nom</label>
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div>
            <label class="block text-sm font-600 text-[#1C1917] mb-1.5">Confirmation</label>
        ...
        <div class="flex items-start gap-3 pt-1">
          ...
          <label for="terms" class="text-sm text-gray-500 leading-snug">
            J'accepte les <a href="#" class="text-amber-600 hover:underline">conditions d'utilisation</a> et la <a href="#" class="text-amber-600 hover:underline">politique de confidentialité</a>.
          </label>
        </div>
