...
<body>
    ...
    <aside class="w-64 bg-[#1C1917] flex flex-col min-h-screen fixed left-0 top-0 z-30">
        ...
        <nav class="flex-1 py-5 px-3 space-y-1">
            ...
            <div class="pt-3 border-t border-white/10 mt-3 space-y-1">
                <p class="px-3 text-xs text-gray-600 font-bold uppercase tracking-widest mb-2">Disponible après avoir
                    rejoint</p>

                <div
                    class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-gray-700 opacity-40 cursor-not-allowed select-none">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <main class="ml-64 min-h-screen flex flex-col">
        ...
        <div class="flex-1 flex flex-col items-center justify-center px-10 py-10">
            ...
            <div class="relative w-72 h-52 mb-10 fu1">
                ...
                <div
                    class="float-1 absolute top-0 left-0 bg-white rounded-2xl shadow-lg border border-gray-100 px-4 py-3 w-44">
                ...
                <div
                    class="float-3 absolute bottom-0 left-1/2 -translate-x-1/2 bg-white rounded-2xl shadow-lg border border-gray-100 px-4 py-3">
                    <p class="text-gray-400 text-xs mb-2">Membres</p>
                    <div class="flex -space-x-2">
                        <div
                            class="w-7 h-7 rounded-full bg-amber-500 border-2 border-white text-white text-xs font-bold flex items-center justify-center">
                            MA</div>
                        <div
                            class="w-7 h-7 rounded-full bg-blue-400 border-2 border-white text-white text-xs font-bold flex items-center justify-center">
                            TL</div>
                        <div
                            class="w-7 h-7 rounded-full bg-emerald-400 border-2 border-white text-white text-xs font-bold flex items-center justify-center">
                            SB</div>
                        <div
                            class="w-7 h-7 rounded-full bg-[#1C1917] border-2 border-white text-amber-400 text-xs font-bold flex items-center justify-center">
                            +</div>
                    </div>
                </div>
                ...
                <!-- Center lock icon -->
                <div
                    class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 rounded-2xl bg-amber-500 shadow-xl shadow-amber-200 flex items-center justify-center z-10">
            ...
            <div class="text-center mb-10 fu2">
                ...
                <p class="text-gray-400 max-w-sm leading-relaxed text-sm">
                    Créez votre propre colocation ou rejoignez-en une existante via un lien d'invitation envoyé par
                    votre colocataire.
                </p>
            </div>
            ...
            <div class="grid grid-cols-2 gap-5 w-full max-w-2xl fu3">
                ...
                <div class="option-card group"
                    ...
                    <!-- Icon -->
                    <div
                        class="w-14 h-14 rounded-2xl bg-[#1C1917] flex items-center justify-center mb-5 group-hover:bg-amber-500 transition-colors">
                        <svg class="w-7 h-7 text-amber-400 group-hover:text-white transition-colors" fill="none"
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed mb-6">
                        Vous devenez <strong class="text-[#1C1917]">Owner</strong>. Vous invitez vos colocataires,
                        gérez les dépenses et les catégories.
                    </p>
                    <!-- Tags -->
                    <div class="flex flex-wrap gap-2 mb-6">
                        <span class="bg-amber-50 text-amber-700 text-xs px-2.5 py-1 rounded-full font-semibold">🏠 Vous
                            êtes Owner</span>
                        <span class="bg-gray-100 text-gray-600 text-xs px-2.5 py-1 rounded-full font-semibold">✉️
                            Invitations email</span>
                        <span class="bg-gray-100 text-gray-600 text-xs px-2.5 py-1 rounded-full font-semibold">🏷️
                            Gestion catégories</span>
                    </div>
                    <button
                ...
                <!-- Option 2: Join -->
                <div class="option-card group"
                    onclick="document.getElementById('modal-join').classList.remove('hidden')">
                    <!-- Icon -->
                    <div
                        class="w-14 h-14 rounded-2xl bg-[#FDF8F2] border border-gray-200 flex items-center justify-center mb-5 group-hover:bg-amber-500 group-hover:border-amber-500 transition-colors">
                        <svg class="w-7 h-7 text-gray-400 group-hover:text-white transition-colors" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed mb-6">
                        Vous devenez <strong class="text-[#1C1917]">Membre</strong>. Collez le lien d'invitation reçu
                        par email de votre Owner.
                    </p>
                    <!-- Tags -->
                    <div class="flex flex-wrap gap-2 mb-6">
                        <span class="bg-blue-50 text-blue-700 text-xs px-2.5 py-1 rounded-full font-semibold">👤 Vous
                            êtes Membre</span>
                        <span class="bg-gray-100 text-gray-600 text-xs px-2.5 py-1 rounded-full font-semibold">🔗 Lien
                            d'invitation</span>
                        <span class="bg-gray-100 text-gray-600 text-xs px-2.5 py-1 rounded-full font-semibold">💸 Suivi
                            dépenses</span>
                    </div>
                    <button
            ...
            <!-- Info note -->
            <div
                class="fu4 mt-8 flex items-start gap-3 bg-amber-50 border border-amber-100 rounded-2xl px-5 py-4 max-w-2xl w-full">
                ...
                <p class="text-amber-800 text-xs leading-relaxed">
                    <strong>Rappel :</strong> vous ne pouvez appartenir qu'à <strong>une seule colocation
                        active</strong> à la fois. Si vous avez reçu un email d'invitation, cliquez directement sur le
                    lien dans l'email plutôt que de coller le token manuellement.
                </p>
            </div>
        ...
        <div class="modal-card">
            ...
            <form action="{{ route('welcome.dashboard') }}" method="POST" class="space-y-4">
                ...
                <div class="bg-[#FDF8F2] rounded-xl p-4 flex items-center gap-3">
                    <div
                        class="w-9 h-9 rounded-full bg-amber-500 text-white font-bold text-sm flex items-center justify-center flex-shrink-0">
                        {{ substr($user, 0, 2) }}</div>
                    <div>
                        <p class="text-sm font-semibold text-[#1C1917]">{{ $user }}</p>
                        <p class="text-xs text-gray-400">Vous serez le <strong class="text-amber-600">Owner</strong>
                            de cette colocation</p>
                    </div>
                </div>
    ...
    <div id="modal-join" class="modal-backdrop hidden">
        <div class="modal-card">
            ...
            <div class="flex items-center gap-4 mb-7">
                <div
                    class="w-12 h-12 rounded-2xl bg-[#FDF8F2] border border-gray-200 flex items-center justify-center flex-shrink-0">
            ...
            <form action="/invitations/accept" method="POST" class="space-y-4">
                ...
                <div class="bg-amber-50 border border-amber-100 rounded-xl p-3.5 flex gap-2.5">
                    ...
                    <p class="text-amber-800 text-xs leading-relaxed">
                        L'email associé à votre compte doit correspondre à l'email sur lequel l'invitation a été
                        envoyée.
                    </p>
                </div>

                <div class="flex gap-3 pt-2">
                    <button type="button" onclick="document.getElementById('modal-join').classList.add('hidden')"
                        class="flex-1 border border-gray-200 text-gray-600 py-3 rounded-xl text-sm font-semibold hover:bg-gray-50 transition">
                        Annuler
                    </button>
                    <button type="submit"
